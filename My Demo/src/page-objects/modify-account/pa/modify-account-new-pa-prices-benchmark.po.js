'use strict';
var ModifyAccountPaPricesBenchmark = function() {
...
/************************************************************************************************************/
ModifyAccountPaPricesBenchmark.prototype.getListItem = function(itemName, sectionName, containerName) {
  // Variable(s)
  var xpathSelectItem;
...
/************************************************************************************************************/
ModifyAccountPaPricesBenchmark.prototype.getElementRemoveButton = function(sectionName, eleName) {
  // Variable(s)
...
/************************************************************************************************************/
ModifyAccountPaPricesBenchmark.prototype.getUsePortPricingForBenchCheckBox = function() {
...
/************************************************************************************************************/
ModifyAccountPaPricesBenchmark.prototype.getAllListElements = function(sectionName, containerName) {
  if (sectionName.toLowerCase() === 'prices') {
    if (containerName.toLowerCase() === 'available') {
      // Return the elements array from the "Available" list
      return element.all(by.xpath(this.xpathPricesAvailableContainer + '//tf-listbox-item//tf-listbox-item-title'));
    } else if (containerName.toLowerCase() === 'selected') {
      // Return the elements array from the "Selected" list
      return element.all(by.xpath(this.xpathPricesSelectedContainer + '//tf-listbox-item//tf-listbox-item-title'));
    }
  }
  ...
  if (sectionName.toLowerCase() === 'exchange rates') {
    if (containerName.toLowerCase() === 'available') {
      // Return the elements array from the "Available" list
      return element.all(by.xpath(this.xpathExchangeRatesAvailableContainer + '//tf-listbox-item//tf-listbox-item-title'));
    } else if (containerName.toLowerCase() === 'selected') {
      // Return the elements array from the "Selected" list
      return element.all(by.xpath(this.xpathExchangeRatesSelectedContainer + '//tf-listbox-item//tf-listbox-item-title'));
    }
  }
};
...
/****************************************************************************************/
ModifyAccountPaPricesBenchmark.prototype.getSection = function(sectionName) {
  var xpathSection;
  if (sectionName.toLowerCase() === 'prices') {
    xpathSection = '//*[@data-qa-id="pricing-section"]' + this.xpathPricesSections;
  } else if (sectionName.toLowerCase() === 'exchange rates') {
    xpathSection = '//*[@data-qa-id="' + sectionName.replace(/\s/g, '-').toLowerCase() + '-section"]' + this.xpathExchangeRatesSections;
  }
...
/****************************************************************************************/
ModifyAccountPaPricesBenchmark.prototype.expandElementTree = function(elementPath, excludeElements) {
  // Variable( s )
  var arrElements;
...
/********************************************************************************************************************/
ModifyAccountPaPricesBenchmark.prototype.isTreeExpanded = function(treePath) {
...
/************************************************************************************************************/
ModifyAccountPaPricesBenchmark.prototype.getArrowButton = function(sectionName) {
  // Variable(s)
...
/************************************************************************************************************/
ModifyAccountPaPricesBenchmark.prototype.getSearchField = function(sectionName) {
  // Variable(s)
...
module.exports = new ModifyAccountPaPricesBenchmark();
