...
describe('Test Case: smart-cache-dev-1', function() {

  // Variable(s)
  var arrTileNames;

  describe('Test Step: 625354', function() {
    ...
    it('Should select "Automatic Calculation" option', function() {
      browser.wait(function() {
        return PA3MainPage.getReportCalculationDlg('Top Positions').isPresent().then(function(visible) {
          return visible;
        });
      }, 10000).then(function() {
      }, function() {
    ...
    it('Should open "Client:/pa3/automation/SMART_CACHE_1" document', function() {
      PA3MainPage.switchToDocument('Client:/Pa3/Automation/SMART_CACHE_1');

      // Checking if application is launched
      browser.getTitle().then(function(title) {
        expect(title === 'Portfolio Analysis 3.0 - Top Positions [Client:/Pa3/Automation/SMART_CACHE_1]')
          .customError('Title of browser did not match. ' +
            'Expected: "Portfolio Analysis 3.0 - Top Positions [Client:/Pa3/Automation/SMART_CACHE_1]",' +
            ' Found: "' + title + '"');
        if (title !== 'Portfolio Analysis 3.0 - Top Positions [Client:/Pa3/Automation/SMART_CACHE_1]') {
          CommonFunctions.takeScreenShot();
        }
      });
    });
  ...
  describe('Test Step: 625355', function() {
  ...
  describe('Test Step: 625356', function() {
  ...
  describe('Test Step: 625357', function() {
  ...
  describe('Test Step: 625364', function() {
  ...
  describe('Test Step: 625365', function() {
