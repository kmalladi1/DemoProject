...
describe('Test Case: cols-general-carbon', function() {
  ...
  describe('Test Step ID: 554926', function() {

    it('Should launch PA3 application with "DEFAULT" document', function() {
      PA3MainPage.switchToDocument('pa-document-default');
    });
    ...
    it('Verifying report theme as "carbon"', function() {
  ...
  describe('Test Step ID: 554913', function() {

    it('Should click on the "Wrench" button in the application toolbar', function() {
    ...
    it('Verifying "CLIENT:/PA3/PA3_TEST2.ACCT" value in the "Portfolio" widget', function() {
      ThiefHelpers.getTextBoxClassReference('Portfolio', PA3MainPage.xpathPortfolioWidget).getText().then(function(option) {
        if (option !== 'CLIENT:/PA3/PA3_TEST2.ACCT') {
          expect(false).customError('"CLIENT:/PA3/PA3_TEST2.ACCT" is not dispalyed');
          CommonFunctions.takeScreenShot();
        }
      });
    });
    ...
    it('Verifying "RUSSELL:1000" value in the "Benchmark" widget', function() {
      ThiefHelpers.getTextBoxClassReference('Benchmark', PA3MainPage.xpathBenchmarkWidget).getText().then(function(option) {
        if (option !== 'RUSSELL:1000') {
          expect(false).customError('"RUSSELL:1000" is not dispalyed.');
          CommonFunctions.takeScreenShot();
        }
      });
    });
  ...
  describe('Test Step ID: 554914', function() {
  ...
  describe('Test Step ID: 554915', function() {

    var flag = 0;

    it('Expand "FactSet|Portfolio|Fixed Income" and select "Port. Ending Factor"', function() {
      var group = ThiefHelpers.getVirtualListboxClassReference(xpathOfAvailableSection).getGroupByText('FactSet');
      group.isExpanded().then(function(expanded) {
        if (expanded) {
    ...
    it('Should select "Net/Gross Ratio" ratio from selected section', function() {
      ...
      // Verify if 'PNet/Gross Ratio' is selected
    ...
    it('Should select "Ticker" from selected section', function() {
      ...
      //Get index of "Ticker" ratio from selected section
  ...
  describe('Test Step ID: 554916', function() {
    ...
    it('Verifying "Decimal" is grayed out in "Format" accordion', function() {
  ...
  describe('Test Step ID: 554917', function() {
    ...
    it('Verifying "Bench. Ending Quantity Held" is not in grey color', function() {
  ...
  describe('Test Step ID: 554918', function() {
    ...
    it('Expand "Format" section in accordion pane', function() {
    ...
    it('Should change the decimal value to ""', function() {
      ThiefHelpers.getTextBoxClassReference('Decimals').setText('').then(function() {}, function(error) {
    ...
    var xpathButton = CommonFunctions.replaceStringInXpath(TileOptionsColumns.xpathDecimalInputButton, 'up');
    it('Should click on upward button in the Decimal number input box', function() {
      element(by.xpath(xpathButton)).click().then(function() {}, function(error) {
        expect(false).customError(error);
        CommonFunctions.takeScreenShot();
      });
    });

    it('Verifying if number field is set to "1"', function() {
      ThiefHelpers.getTextBoxClassReference('Decimals').getText().then(function(value) {
        if (value !== '1') {
          expect(false).customError('"Decimals value is not 1. Found' + value);
          CommonFunctions.takeScreenShot();
        }
      });
    });
    ...
    it('Should change the decimal value to "4"', function() {
      // Change the decimal value to "4"
      ThiefHelpers.getTextBoxClassReference('Decimals').setText('4');

      //Verifying the decimal value to be "4"
      ThiefHelpers.getTextBoxClassReference('Decimals').getText().then(function(value) {
        if (value !== '4') {
          expect(false).customError('"Decimals value is not 4. Found' + value);
          CommonFunctions.takeScreenShot();
        }
      });
    });

    it('Should note the width value', function() {
  ...
  describe('Test Step ID: 554923', function() {
    ...
    it('Should change the Width value to "25"', function() {
      // Changing the Width value to "25"
  ...
  describe('Test Step ID: 554919', function() {
    ...
    it('Verifying if calculated data for "Pre & Post Trade" report appeared without any errors', function() {
      //Verifying Pre & Post Trade reports calculated
  ...
  describe('Test Step ID: 554920', function() {
    ...
    var selectedSectionElement = ['Trade Impact Quantity Held', 'Port. Ending Weight', 'Bench. Ending Weight', 'Variation in Ending Weight'];

    selectedSectionElement.forEach(function(selectedSectionElement) {

      it('Verifying "' + selectedSectionElement + '" is grey color', function() {
  ...
  describe('Test Step ID: 554921', function() {

    it('Should select "Trade Impact Quantity Held" from selected section', function() {
  ...
  describe('Test Step ID: 554922', function() {
  ...
  describe('Test Step ID: 554924', function() {
  ...
  describe('Test Step ID: 554925', function() {
    ...
    it('Should enter "Maturity" into search field in available section', function() {
      //Enter maturity into search field
    ...
    it('Verifying report theme as "carbon"', function() {
      ...
      element(by.xpath(PA3MainPage.xpathApp)).getAttribute('class').then(function(value) {
        if (value.indexOf('carbon') !== -1) {
          expect(false).customError('Report theme is still carbon');
        }
      });
    });
